 ...
 *
 *  Copyright 2020 SomeoneKindaTechnical
 *
 ...
 *
 *  This is a fork of code by cscheinene. I am using to learn from.
 *
 */
def clientVersion() {
    return "01.00.01"
...
metadata {
	definition (name: "Netatmo Addtl Module V01.00.01", namespace: "SomeoneKindaTechnical", author: "SomeoneKindaTechnical", cstHandler: true, ofcDeviceType: "oic.d.thermostat") {
